...
def call_back(msg,twist_pub):
	...
	joints_pos_new_list[3] = joints_pos_new_list[3]+3
	joints_pos_new_list[4] = joints_pos_new_list[4]+3
	joints_pos_new_list[5] = joints_pos_new_list[5]+3
...
def main():
	...
	d_duration = 0.0
	rate = rospy.Rate(50)
	rospy.Subscriber('left_joy',Joy,call_back,twist_pub,queue_size = 20)
